...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $email_content .= "<img src='https://aaronpeskowitz.com/assets/images/logo_full.png' alt='Aaron Peskowitz Real Estate' style='max-width:240px; width:100%; height:auto; display:block; margin:0 auto;'>";
    $email_content .= "</td></tr>";
